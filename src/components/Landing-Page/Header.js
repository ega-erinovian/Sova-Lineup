    ...
    <section className="header-container">
      ...
      <div className="content-container">
        ...
        <div className="agent-img">
          <img src="https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltf11234f4775729b7/5ebf2c275e73766852c8d5d4/V_AGENTS_587x900_ALL_Sova_2.png" alt="sova-img-header" />
        </div>
      </div>
    </section>
  );
